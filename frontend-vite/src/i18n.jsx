...
const translations = {
  es: {
    ...
    'howItWorks.step1Note': 'La competencia inicia cuando se alcancen 5+ participantes',
    'howItWorks.step2Title': 'Paga tu Entrada',
    'howItWorks.step2Desc': 'Elige tu red USDT (Polygon, TRC-20 o Ethereum) y paga. $10 de tu entrada van al prize pool.',
    'howItWorks.step2ExampleLabel': 'Ej. por nivel',
    'howItWorks.step3Title': 'Compite',
    'howItWorks.step3Desc': 'Abre trades en divisas, criptos y commodities con precios en tiempo real',
    'howItWorks.step3Note': 'Ranking en tiempo real con datos LIVE de cada usuario',
    'howItWorks.step4Title': 'Gana & Retira',
    'howItWorks.step4Desc': 'Si terminas en el Top 3, recibes tu premio USDT directamente en tu wallet',
    'howItWorks.featuresTitle': '¿Por qué Holypot?',
    'howItWorks.feature1Title': 'Basado en Habilidad',
    'howItWorks.feature1Desc': 'No es gambling. Gana demostrando tu destreza real en los mercados',
    ...
    'howItWorks.feature3Desc': 'Recibe USDT reales transferidos automáticamente a tu wallet',
    ...
    // Profile redesign — nuevas claves visuales
    'profile.currentComp':    'Competencia Actual',
    'profile.noActiveComp':   'Sin competencia activa',
    'profile.joinNow':        '¡Inscríbete ahora!',
    'profile.yourPosition':   'Tu Posición',
    'profile.roi':            'ROI Actual',
    'profile.projectedLevel': 'Nivel Proyectado',
    'profile.xpGlobal':       'XP Global',
    'profile.xpToNext':       'para siguiente nivel',
    'profile.statsOverview':  'Resumen estadístico',
    'profile.competitions':   'Competencias',
    'profile.winRate':        'Win Rate',
    'profile.aiSection':      'IA del Día',
    'profile.aiSubtitle':     'Tu consejo personalizado',
    'profile.aiBy':           'by Grok AI',
    'profile.aiUpdatedDaily': 'Actualizado cada 24 horas',
    'profile.share':          'Compartir',
    'profile.tier':           'Tier',
    'profile.biasConsistency':'consistencia',
    'profile.openFirstTrade': '¡Abre tu primer trade!',
    'profile.wins':           'Ganadoras',
    'profile.losses':         'Perdedoras',
    'profile.achievedLevel':  'Nivel conseguido',
    ...
    'rules.title': 'Reglas de las Competencias – Holypot Trading 🚀',
    'rules.backBtn': '← Volver a Holypot Trading',
    ...
    'rules.schedule_min': 'Mínimo requerido: 5 participantes pagados para que la competencia se active y sea válida.',
    'rules.schedule_last': 'Última inscripción permitida: 18:00 UTC.',
    ...
    'rules.trading_lotsize': 'Tamaño de lote ajustable (porcentaje de riesgo en vivo).',
    'rules.trading_minclosed': 'Requisito mínimo: cerrar al menos 1 operación durante la competencia para aparecer en el ranking.',
    'rules.trading_drawdown': 'Drawdown máximo permitido: 10% del capital inicial. Si el capital cae por debajo del 90% del valor inicial, la cuenta es descalificada automáticamente e inmediatamente.',
    'rules.calcReturn': 'Cálculo de rendimiento',
    'rules.calcFormula': 'Retorno % = (capital final − capital inicial) / capital inicial × 100.',
    ...
    'rules.tiebreak3': 'Menor drawdown máximo (%) durante la competencia.',
    'rules.tiebreak4': 'Timestamp más temprano de inscripción pagada.',
    'rules.prizePayout': 'Pago de premios',
    'rules.prizePayoutDesc': 'Los premios se abonan automáticamente (o manualmente en fase inicial) en USDT a la wallet del usuario inmediatamente después del cierre de la competencia válida.',
    'rules.prohibited': 'Conducta prohibida',
    'rules.prohibitedDesc': 'Queda estrictamente prohibido el uso de bots, cuentas múltiples, colusión, manipulación de resultados o cualquier conducta fraudulenta. La Plataforma se reserva el derecho de descalificar participantes y retener premios en caso de incumplimiento.',
    ...
    'terms.title': 'Términos y Condiciones de Uso – Holypot Trading',
    'terms.lastUpdate': 'Última actualización: 25 de enero de 2026',
    'terms.backBtn': '← Volver a Holypot Trading',
    'terms.sec1_title': '1. Aceptación de los Términos',
    'terms.sec1_content': 'Al registrarte, acceder o utilizar la plataforma Holypot Trading (en adelante, la "Plataforma"), aceptas vincularte legalmente por estos Términos y Condiciones. Si no estás de acuerdo, no podrás usar la Plataforma.',
    'terms.sec2_title': '2. Elegibilidad',
    'terms.sec2_li1': 'Debes tener al menos 18 años de edad o la mayoría de edad legal en tu jurisdicción.',
    'terms.sec2_li2': 'Quedan excluidos residentes de países o territorios donde las competencias con entrada pagada y premios en dinero estén prohibidas por la ley aplicable.',
    ...
    'terms.sec3_p1': 'Holypot Trading es una plataforma tecnológica que permite competencias privadas de trading simulado de divisas (FX) basadas predominantemente en habilidad, conocimiento y estrategia.',
    'terms.sec3_p2': 'La Plataforma actúa exclusivamente como proveedor de infraestructura técnica, árbitro neutral y facilitador de pagos.',
    'terms.sec3_p3': 'No se trata de un juego de azar. No existe garantía de ganancias. El riesgo del usuario está limitado a la cuota de inscripción.',
    'terms.sec4_title': '4. Registro y Cuenta',
    'terms.sec4_li1': 'Debes proporcionar información veraz, completa y actualizada.',
    'terms.sec4_li2': 'Eres responsable de mantener la confidencialidad de tus credenciales.',
    'terms.sec4_li3': 'La Plataforma podrá requerir verificación de identidad para retiros o cumplimiento legal.',
    'terms.sec5_title': '5. Creación, Inscripción y Reglas de las Competencias',
    'terms.sec5_li1': 'Máximo 20 trades/día por usuario.',
    'terms.sec5_li2': 'LotSize 0.01-1.0 (risk 0.1%-10%).',
    'terms.sec5_li3': 'Órdenes market/limit/stop.',
    'terms.sec5_li4': 'Competencia activa con mínimo 5 participantes.',
    'terms.sec5_li5': 'Prohibido bots, multi-cuentas, colusión o fraude.',
    ...
    'terms.sec8_content': 'Procesados vía métodos habilitados. Mínimo retiro + comisiones externas. Verificación adicional posible.',
    'terms.sec9_title': '9. Limitación de Responsabilidad',
    'terms.sec9_content': 'Plataforma "tal cual" sin garantías. Responsabilidad máxima limitada a comisiones pagadas últimos 30 días.',
    'terms.sec10_title': '10. Propiedad Intelectual',
    'terms.sec10_content': 'Todo contenido, software, marcas y diseño propiedad exclusiva Holypot Trading.',
    'terms.sec11_title': '11. Terminación y Suspensión',
    'terms.sec11_content': 'Suspensión/cierre cuentas por incumplimiento, fraude o riesgo legal.',
    'terms.sec12_title': '12. Ley Aplicable y Jurisdicción',
    'terms.sec12_content': 'Leyes República de Colombia. Tribunales Pereira, Risaralda.',
    'terms.sec13_title': '13. Modificaciones',
    'terms.sec13_content': 'Modificaciones notificadas con 15 días antelación por email/plataforma.',

    // Privacy Policy
    'privacy.title': 'Política de Privacidad – Holypot Trading',
    'privacy.lastUpdate': 'Última actualización: 25 de enero de 2026',
    'privacy.backBtn': '← Volver a Holypot Trading',
    'privacy.sec1_title': '1. Información que recolectamos',
    'privacy.sec1_li1': 'Datos de registro: email, contraseña, wallet TRC20, nickname, fecha nacimiento (verificación edad mayor 18).',
    'privacy.sec1_li2': 'Datos transacciones: historial inscripciones, trades, payouts.',
    'privacy.sec1_li3': 'Datos técnicos: IP, dispositivo, navegador (mejora servicio y seguridad).',
    ...
    'privacy.sec2_li3': 'Mejorar experiencia y seguridad (análisis uso, prevención fraude).',
    'privacy.sec2_li4': 'Comunicaciones operativas (confirmación pago, resultados competencia).',
    'privacy.sec2_li5': 'No marketing sin consentimiento expreso.',
    'privacy.sec3_title': '3. Base legal',
    'privacy.sec3_content': 'Ejecución contrato (Términos Uso), cumplimiento legal y consentimiento usuario.',
    'privacy.sec4_title': '4. Compartición datos',
    'privacy.sec4_intro': 'Solo compartimos con:',
    'privacy.sec4_li1': 'Procesadores pago (NOWPayments) y proveedores técnicos.',
    'privacy.sec4_li2': 'Autoridades cuando ley lo exija.',
    'privacy.sec5_title': '5. Seguridad',
    'privacy.sec5_content': 'SSL, encriptación datos sensibles, acceso restringido, monitoreo constante.',
    'privacy.sec6_title': '6. Derechos titular',
    'privacy.sec6_content': 'Acceso, rectificación, supresión, revocación consentimiento. Envía solicitud a soporte@holypottrading.com.',
    'privacy.sec7_title': '7. Transferencias internacionales',
    'privacy.sec7_content': 'Proveedores (AWS, NOWPayments) fuera Colombia – estándares protección equivalentes GDPR-like.',
    'privacy.sec8_title': '8. Cambios política',
    'privacy.sec8_content': 'Notificaremos modificaciones con antelación por email o plataforma.',
    ...
    // Admin dashboard redesign — nuevas claves
    'admin.activeParticipants':  'Participantes Activos',
    'admin.searchUser':          'Buscar trader o wallet...',
    'admin.allLevels':           'Todos los niveles',
    'admin.allStatuses':         'Todos los estados',
    'admin.network':             'Red',
    'admin.totalPaid':           'Total pagado',
    'admin.totalPending':        'Pendientes',
    'admin.confirmAll':          '¿Confirmar liquidación total?',
    'admin.settleConfirmDesc':   'Esta acción procesará pagos reales en blockchain. Es irreversible.',
    'admin.processing':          'Procesando...',
    'admin.settleAll':           'Liquidar Todo',
    'admin.settleNetwork':       'Liquidar',
    'admin.noPayoutsPending':    'No hay payouts pendientes',
    'admin.noBatches':           'Sin batches aún',
    'admin.batchHistory':        'Historial de Batches',
    'admin.payoutSettlement':    'Payout Settlement',
    'admin.lastUpdated':         'Actualizado',
    'admin.refresh':             'Actualizar',
    'admin.analytics':           'Analytics',
    'admin.revenueVsPool':       'Revenue vs Prize Pool',
    'admin.signupsByLevel':      'Inscripciones por nivel',
    'admin.payoutsDistribution': 'Distribución de Payouts',
  ...
  en: {
    ...
    'howItWorks.step1Note': 'Competition starts when 5+ participants join',
    'howItWorks.step2Title': 'Pay Your Entry',
    'howItWorks.step2Desc': 'Choose your USDT network (Polygon, TRC-20 or Ethereum) and pay. $10 of your entry goes to the prize pool.',
    'howItWorks.step2ExampleLabel': 'E.g. by level',
    'howItWorks.step3Title': 'Compete',
    'howItWorks.step3Desc': 'Open trades on currencies, cryptos and commodities with real-time prices',
    'howItWorks.step3Note': 'Live ranking with real-time data from every user',
    'howItWorks.step4Title': 'Win & Withdraw',
    'howItWorks.step4Desc': 'If you finish in the Top 3, receive your USDT prize directly to your wallet',
    'howItWorks.featuresTitle': 'Why Holypot?',
    'howItWorks.feature1Title': 'Skill-Based',
    'howItWorks.feature1Desc': 'Not gambling. Win by demonstrating your real trading skills',
    'howItWorks.feature2Title': 'Auditable',
    'howItWorks.feature2Desc': 'All trades and prizes are transparent and verifiable',
    'howItWorks.feature3Title': 'Real Prizes',
    'howItWorks.feature3Desc': 'Receive real USDT automatically transferred to your wallet',
    ...
    // Profile redesign — new visual keys
    'profile.currentComp':    'Current Competition',
    'profile.noActiveComp':   'No active competition',
    'profile.joinNow':        'Join now!',
    'profile.yourPosition':   'Your Position',
    'profile.roi':            'Current ROI',
    'profile.projectedLevel': 'Projected Level',
    'profile.xpGlobal':       'Global XP',
    'profile.xpToNext':       'to next level',
    'profile.statsOverview':  'Stats Overview',
    'profile.competitions':   'Competitions',
    'profile.winRate':        'Win Rate',
    'profile.aiSection':      'AI of the Day',
    'profile.aiSubtitle':     'Your personalized tip',
    'profile.aiBy':           'by Grok AI',
    'profile.aiUpdatedDaily': 'Updated every 24 hours',
    'profile.share':          'Share',
    'profile.tier':           'Tier',
    'profile.biasConsistency':'consistency',
    'profile.openFirstTrade': 'Open your first trade!',
    'profile.wins':           'Wins',
    'profile.losses':         'Losses',
    'profile.achievedLevel':  'Achieved level',
    ...
    // Rules
    'rules.title': 'Competition Rules – Holypot Trading 🚀',
    'rules.backBtn': '← Back to Holypot Trading',
    ...
    'rules.trading_drawdown': 'Maximum allowed drawdown: 10% of initial capital. If capital falls below 90% of the initial value, the account is automatically and immediately disqualified.',
    'rules.calcReturn': 'Return Calculation',
    'rules.calcFormula': 'Return % = (final capital − initial capital) / initial capital × 100.',
    ...
    // Terms and Conditions
    'terms.title': 'Terms and Conditions of Use – Holypot Trading',
    'terms.lastUpdate': 'Last updated: January 25, 2026',
    'terms.backBtn': '← Back to Holypot Trading',
    ...
    // Privacy Policy
    'privacy.title': 'Privacy Policy – Holypot Trading',
    'privacy.lastUpdate': 'Last updated: January 25, 2026',
    'privacy.backBtn': '← Back to Holypot Trading',
    ...
    'privacy.sec7_content': 'Providers (AWS, NOWPayments) outside Colombia – equivalent GDPR-like protection standards.',
    ...
    // Admin dashboard redesign — new keys
    'admin.activeParticipants':  'Active Participants',
    'admin.searchUser':          'Search trader or wallet...',
    'admin.allLevels':           'All levels',
    'admin.allStatuses':         'All statuses',
    'admin.network':             'Network',
    'admin.totalPaid':           'Total paid',
    'admin.totalPending':        'Pending',
    'admin.confirmAll':          'Confirm full settlement?',
    'admin.settleConfirmDesc':   'This action will process real blockchain payments. It is irreversible.',
    'admin.processing':          'Processing...',
    'admin.settleAll':           'Settle All',
    'admin.settleNetwork':       'Settle',
    'admin.noPayoutsPending':    'No pending payouts',
    'admin.noBatches':           'No batches yet',
    'admin.batchHistory':        'Batch History',
    'admin.payoutSettlement':    'Payout Settlement',
    'admin.lastUpdated':         'Updated',
    'admin.refresh':             'Refresh',
    'admin.analytics':           'Analytics',
    'admin.revenueVsPool':       'Revenue vs Prize Pool',
    'admin.signupsByLevel':      'Sign-ups by level',
    'admin.payoutsDistribution': 'Payouts Distribution',
    'admin.cancel':              'Cancel',
