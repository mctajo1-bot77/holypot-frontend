...
const translations = {
  es: {
    ...
    'howItWorks.step2Desc': 'Elige tu red USDT (Polygon, TRC-20 o Ethereum) y completa el pago de inscripción',
  ...
  en: {
    ...
    'howItWorks.step2Desc': 'Choose your USDT network (Polygon, TRC-20 or Ethereum) and complete the entry payment',
